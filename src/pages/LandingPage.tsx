          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-300 leading-relaxed">
                Choose from friendly, professional, confident, or funny tones to match your brand voice perfectly.
              </p>
            </div>
            ...
            <div className="group bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-green-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">One-Click Export</h3>
              <p className="text-gray-300 leading-relaxed">
                Copy your generated emails instantly or export to your favorite email client with a single click.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-300 leading-relaxed">
                Enter your details, recipient information, and the purpose of your outreach. Choose your preferred tone.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-300 leading-relaxed">
                Our advanced AI analyzes your input and generates personalized cold emails and follow-ups in seconds.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Copy & Send</h3>
              <p className="text-gray-300 leading-relaxed">
                Review, copy, and send your perfectly crafted emails. Watch your response rates soar!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                "ColdSpark increased my response rate by 300%. The AI-generated emails feel natural and personal."
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                "The voice message feature is a game-changer. It adds a personal touch that sets me apart."
              </p>
              <div className="flex items-center">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                "I save hours every week with ColdSpark. The follow-up emails are perfectly timed and effective."
              </p>
              <div className="flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  <span className="text-gray-200">Basic AI generation</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  <span className="text-gray-200">Email templates</span>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 backdrop-blur-lg rounded-2xl p-8 border border-purple-500/50 relative">
              ...
              <div className="text-center mb-8">
                ...
                <div className="text-4xl font-bold text-white mb-4">$3<span className="text-lg">/month</span></div>
